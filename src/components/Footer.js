      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-blue-600">Casava</h3>
            <p className="text-gray-500 text-sm">
              Your one-stop shop for quality products at great prices. We provide the best shopping experience for our customers.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/shipping" className="text-gray-500 hover:text-gray-900">
                  Shipping Information
                </Link>
              </li>
              <li>
                <Link to="/returns" className="text-gray-500 hover:text-gray-900">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
            ...
            <form className="mt-4">
              <div className="flex">
                <input
                  ...
                  className="flex-1 min-w-0 px-4 py-2 text-sm border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                <button
                  type="submit"
